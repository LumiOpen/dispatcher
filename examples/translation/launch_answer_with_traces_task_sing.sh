...
OUTPUT_FILE=${DATADIR}/${FILE_NAME}_answers_with_traces_${MODEL_NAME}_${LANGUAGE}.jsonl
TASK=answering_with_traces_task.AnsweringWithTracesTask
...
WORK_TIMEOUT=3600   # time for dispatcher to give up on a work item and reissue it.  ideally this should never be hit.
