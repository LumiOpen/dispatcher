...
#export MODEL=${2:-"Qwen/Qwen2.5-0.5B-Instruct"}
MODEL_NAME=$(basename "$MODEL")
INPUT_FILE=/scratch/project_462000353/khakala/lib/dispatcher/examples/translation/default-train-sample-10_translations_Qwen2.5-72B-Instruct_fi.jsonl
