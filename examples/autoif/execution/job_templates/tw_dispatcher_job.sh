...
INPUT_FILE=/shared_silo/scratch/adamhrin@amd.com/dispatcher/examples/autoif/data/tw_initial/verifiers_queries.jsonl
OUTPUT_FILE=/shared_silo/scratch/adamhrin@amd.com/dispatcher/examples/autoif/data/tw_initial/scored_responses.jsonl
...
# SLURM variables are automatically translated to APPTAINERENV_* by the launcher
...
srun -l bash -c "
  run_sing_bash '
    ...
    # enable HF downloads for glotlid model
