...
def process_output(input_file: str, output_file: str, language: str = 'en', max_instructions: int = 100) -> None:
    """
...
def main():
    ...
    process_output(args.input_file, args.output_file, args.language, args.max_instructions)
