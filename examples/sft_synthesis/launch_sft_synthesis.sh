#!/bin/bash
#SBATCH --job-name=sft_multiple_responses
#SBATCH --nodes=1
...
export MODEL=${1:-"meta-llama/Llama-3.1-8B-Instruct"}
MODEL_NAME=$(basename "$MODEL")
INPUT_FILE=/scratch/project_462000353/posttraining_data/SFTTrainer_format/eng/tulu-3-sft-mixture/train.jsonl
OUTPUT_FILE=sft_test.jsonl
TASK=sft_multiple_responses_task.MultipleResponsesTask
...
MAX_MODEL_LEN=32768 # for efficiency, only as much as you think you need for efficiency
...
cd /scratch/project_462000353/zosaelai2/LumiOpen/sft_synthesis/dispatcher
pip install -e .
# pip install fasttext
cd /scratch/project_462000353/zosaelai2/LumiOpen/sft_synthesis/dispatcher/examples/sft_synthesis
