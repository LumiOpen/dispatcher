...
cd /scratch/project_462000353/zosaelai2/LumiOpen/autoif/dispatcher
pip install -e .
# pip install fasttext
cd /scratch/project_462000353/zosaelai2/LumiOpen/autoif/dispatcher/examples/sft_synthesis
