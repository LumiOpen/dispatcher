#!/bin/bash
#SBATCH --job-name=KR-math-translation
#SBATCH --nodes=2
...
INPUT_FILE=/shared_silo/scratch/kahakala/data/KlearReasoner-MathSub-30K/KlearReasoner-MathSub-30K-RL-train-processed.jsonl
OUTPUT_FILE=/shared_silo/scratch/adamhrin@amd.com/dispatcher/examples/reasoning_traces/data/KlearReasoner-MathSub-30K-RL-train-processed_translated_DeepSeek-V3_fi.jsonl
TASK=tasks.problem_translation_task.ProblemTranslationTask
export LANGUAGE=fi
