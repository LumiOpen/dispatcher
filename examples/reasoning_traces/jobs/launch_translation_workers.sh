...
#SBATCH --job-name=trans-aiter-test
...
TASK=${TASK:-tasks.reasoning_translation_task.ReasoningTranslationTask}
export LANGUAGE=${LANGUAGE:-fi}

export MODEL=${MODEL:-/shared_silo/scratch/models/DeepSeek-V3}
