...
export LANGUAGE="$1"
echo "Running DocQA for: ${LANGUAGE^^}"
INPUT_FILE=/scratch/project_462000353/posttraining_data/wikipedia/20231101.$LANGUAGE.jsonl
OUTPUT_FILE=multi_turn_complex_$LANGUAGE.jsonl
TASK=doc_qa_pipeline_task.GenerateConversationJudgingFromDocumentsTask
...
MAX_MODEL_LEN=40960 # for efficiency, only as much as you think you need for efficiency
...
cd /scratch/project_462000353/zosaelai2/LumiOpen/dispatcher
pip install -e .
# pip install fasttext
cd /scratch/project_462000353/zosaelai2/LumiOpen/dispatcher/examples/document-answering
